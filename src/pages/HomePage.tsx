        ...
        <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3 md:px-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-full bg-gradient-to-r from-amber-400/20 to-amber-500/10 border border-amber-400/25 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-amber-500 dark:text-amber-300 transition-all hover:scale-105 active:scale-95"
            >
