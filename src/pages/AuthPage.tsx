...
const AuthPage = () => {
  ...
  useEffect(() => {
    ...
    if (stored && LOGIN_METHOD_LABELS[stored]) {
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-8 md:py-16">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-lg md:p-8">
            {/* Social buttons - vertical stack with brackets */}
            <div className="space-y-4 mb-6">
              {/* Email button */}
              <LastLoginBrackets isHighlighted={lastMethod === "email"} label="Email">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 rounded-xl font-medium gap-2.5 text-sm"
                  onClick={() => {
                    /* Show email form below or scroll to it */
                  }}
                >
              ...
              {/* Google button */}
              <LastLoginBrackets isHighlighted={lastMethod === "google"} label="Google">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 rounded-xl font-medium gap-2.5 text-sm"
              ...
              {/* Apple button */}
              <LastLoginBrackets isHighlighted={lastMethod === "apple"} label="Apple">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 rounded-xl font-medium gap-2.5 text-sm"
            ...
            {lastMethod && isLogin && (
              <p className="text-center text-xs text-muted-foreground mb-6 flex items-center justify-center gap-2">
                <span className="inline-block w-3 h-3 rounded-full border-[1.5px] border-primary/60" />
